...
def preprocessing():
    ...
    diabetes_df = format_class_values(diabetes_df, ['Outcome'])
...
def classifier_script():
    ...
    diabetes_training, diabetes_test = LogisticClassifier.split_training_test_subsets(diabetes_df)
    ...
    weight_vector = LogisticClassifier.calculate_weight_vector(diabetes_training_data, diabetes_training_class_vector)
    # print(weight_vector)

    # calcula os resultados
    predicted_results = LogisticClassifier.calculate_results(weight_vector, diabetes_test_data)

    error_rate = LogisticClassifier.error_rate(predicted_results, diabetes_test_class_vector)
    confusion_matrix = LogisticClassifier.conf_matrix(predicted_results, diabetes_test_class_vector)
