...
def preprocessing():
    ...
    # formata valores da classe
    hepatitis_df = format_class_values(hepatitis_df, ['class'])
...
def classifier_script():
    ...
    hepatitis_training, hepatitis_test = LogisticClassifier.split_training_test_subsets(hepatitis_df)
    ...
    # calcula o modelo. OS PARAMETROS LIVRES DEVEM SER MODIFICADOS AQUI
    weight_vector = LogisticClassifier.calculate_weight_vector(hepatitis_training_data, hepatitis_training_class_vector)

    # calcula os resultados
    predicted_results = LogisticClassifier.calculate_results(weight_vector, hepatitis_test_data)

    error_rate = LogisticClassifier.error_rate(predicted_results, hepatitis_test_class_vector)
    confusion_matrix = LogisticClassifier.conf_matrix(predicted_results, hepatitis_test_class_vector)
