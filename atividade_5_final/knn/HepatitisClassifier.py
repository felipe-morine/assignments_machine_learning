...
if __name__=="__main__":
    numeric_features = ['bilirubin', 'alk_phosphate', 'sgot', 'albumin', 'protime']
    ...
    X_training = iris_training.drop(class_label, axis=1)
    y_training = iris_training[class_label]
    ...
    # normaliza o conjunto de treinamento de teste
